...
public class Televisao extends Dispositivo {
    ...
    public Televisao(String marca, String modelo, double consumoEnergia, int tamanhoPolegadas, String resolucao, boolean smart) {
    ...
    public void executarFuncao(){
        System.out.println("A televisão está executando uma função");
}
}