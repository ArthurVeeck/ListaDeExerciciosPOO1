...
public class Engenheiro extends Profissao {
    ...
    public Engenheiro(String nome, double salarioMedio, String area, String especialidade, String empresa, int projetos) {
    ...
    public void executarTrabalho() {
        System.out.println("O engenheiro esta desenvolvendo um projeto");
    }
}