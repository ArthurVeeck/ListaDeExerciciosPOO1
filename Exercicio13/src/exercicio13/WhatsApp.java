...
public class WhatsApp extends Notificacao {
    ...
    public WhatsApp(String destinatario, String mensagem, String dataEnvio, String numeroTelefone, boolean confirmacaoLeitura, boolean midia) {
    ...
    public boolean getConfirmacaoLeitura() {
